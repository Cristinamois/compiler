...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "IDENTIFIER",
  "ASSIGN", "$accept", "assignment", "expression", YY_NULLPTR
};
...
{
       9,    12,    13,     5,    15,    16,    17,    18,     6,     1,
       7,    10,    11,    12,    13,     3,    14,    10,    11,    12,
      13,     4
};

static const yytype_int8 yycheck[] =
{
       6,     6,     7,     3,    10,    11,    12,    13,     8,    10,
      10,     4,     5,     6,     7,    11,     9,     4,     5,     6,
       7,     0
};
...
{
       0,    10,    13,    11,     0,     3,     8,    10,    14,    14,
       4,     5,     6,     7,     9,    14,    14,    14,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* assignment: IDENTIFIER ASSIGN expression  */
#line 16 "parser.y"
                                         { add_variable(yyvsp[-2], yyvsp[0]); }
...
#line 1087 "parser.tab.c"
  ...
  case 5: /* expression: expression MULTIPLY expression  */
#line 25 "parser.y"
                                           { yyval = yyvsp[-2] * yyvsp[0]; }
...
#line 27 "parser.y"
                       {yyval = get_variable_value(yyvsp[0]); }
